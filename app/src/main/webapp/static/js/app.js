...
/***/ function(module, exports, __webpack_require__) {
	...
	var IntervalTimer = Mixins.IntervalMixer(Components.Timer);
	var ping = (function () {
	    var times = 0;
	    return function () {
	        return times++;
	...
	$(function () {
	    ReactDOM.render(React.createElement(IntervalTimer, {interval: 1000, onInterval: ping}), document.getElementById('app-home-body'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = (function (_super) {
	    ...
	    Timer.prototype.render = function () {
	        return (React.createElement("div", null, this.props.data, " seconds"));
	    };
	    Timer.defaultProps = {
	        data: 0
	    };
